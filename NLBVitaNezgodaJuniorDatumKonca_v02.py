...
def main():
    db, username, password = DBu.getDBConnectionParams((1,))
    claim:str = input("Zahtevek: ")
    today:str = datetime.today().strftime('%Y-%m-%d')
    if not claim.startswith("#"): claim = "#" + claim
    path_SQL:str = r"I:\SEKTOR INFORMATIKE IN TEHNOLOGIJE\TEHNOLOGIJA\Selecti\Nezgoda in Junior\Police NLB Vita Nezgoda Junior z napačnim datumom konca zavarovanja.sql"
    path_file:str = getcwd()
